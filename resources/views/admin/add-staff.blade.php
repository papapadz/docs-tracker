...
<head>
	<title>Dog Coach Francis - Add New Pet Care Assistant</title>
</head>
...
<div class="container">
  ...
  <div class="card">
    ...
    <h5><i class="fa fa-paw"></i>Pet Care Assistant's Information</h5>
      <form class="col s12" id="addstaff" method="POST" runat="server" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="row">
					<center>
        ...
        <div class="row">
          ...
          <div class="input-field col s6">
            <input id="nname" type="text" class="validate" name="nname">
        ...
        <div class="row">
            <div class="input-field col s6">
              <input name="empdate" placeholder="Start of Employment" type="text" class="datepicker">
            </div>
            <div class="input-field col s6">
              <select name="stat">
