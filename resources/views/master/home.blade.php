...
<div class="btn-group mr-2" role="group">
    ...
    <button id="btnGroupDrop1" type="button" class="btn btn-sm bg-success dropdown-toggle text-white" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    New Document
    </button>
    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
        @foreach($types as $dt)
        <a class="dropdown-item" href='{{ url("new-doc/".$dt->doctype_id) }}'>{{$dt->doc_type}}</a>
        @endforeach
    </div>
</div>
@endsection
